...
class BarnesNoblesController:
    ...
    def validate_barnesnobles(self, agent: Dict[str, str | Dict[str, str]], headless: bool = True, total_books: int = 50, total_subject: int = 200) -> None:
        ...
        closed_category: str = "snippy/cache/barnesnobles/closed_category_links/openlibrary.json"

        open_category: str = "snippy/cache/barnesnobles/open_category_links/openlibrary.json"
        open_category_book: str = "snippy/cache/barnesnobles/open_category_links/openlibrary_books.json"
